...
「コントラクター：空いた時間に副収入を得たい請負人(contractor)」
をマッチングさせる。
...
同様のサービスはすでに複数存在するが、肥大化したサービス内容や、専門性の高いスキルを売りとした市場となっているため、気軽さを売りとした当サービス「ちょっとおてつだい」については、それらサービスとは住み分けや差別化を図り、誰でも気軽に利用出来るサービス展開を目指します。
